export const isJsonObject = (x) => { return x !== undefined && x !== null && x.constructor == Object; };
// 
export var REST;
(function (REST) {
    let Method;
    ...
    (function (Response) {
        ...
        function fromJson(json) {
            return new globalThis.Response(JSON.stringify(json.body, null, 2), {
                status: json.code,
